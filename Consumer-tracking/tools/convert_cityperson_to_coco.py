...
DATA_PATH = '/media/seyeimpala/ImpalaStorage/datasets/MOT/'
...
if __name__ == '__main__':
    ...
    for img_path, label_path in zip(img_paths, label_paths):
        image_cnt += 1
        im = Image.open(os.path.join("/media/seyeimpala/ImpalaStorage/datasets/MOT", img_path))
        ...
        # Load labels
        if os.path.isfile(os.path.join("/media/seyeimpala/ImpalaStorage/datasets/MOT/", label_path)):
            labels0 = np.loadtxt(os.path.join("/media/seyeimpala/ImpalaStorage/datasets/MOT/", label_path), dtype=np.float32).reshape(-1, 6)
