...
mot_json = json.load(open('/media/seyeimpala/ImpalaStorage/datasets/MOT/MOT17/annotations/train.json','r'))
...
crowdhuman_json = json.load(open('/media/seyeimpala/ImpalaStorage/datasets/MOT/CrowdHuman/annotations/train.json','r'))
img_id_count = 0
...
crowdhuman_val_json = json.load(open('/media/seyeimpala/ImpalaStorage/datasets/MOT/CrowdHuman/annotations/val.json','r'))
img_id_count = 0
...
ethz_json = json.load(open('/media/seyeimpala/ImpalaStorage/datasets/MOT/ETHZ/annotations/train.json','r'))
img_id_count = 0
...
cp_json = json.load(open('/media/seyeimpala/ImpalaStorage/datasets/MOT/Cityscapes/annotations/train.json','r'))
img_id_count = 0
