...
def make_parser():
    ...
    parser.add_argument('--lstm_weights', type=str, default='weights/lstm_128.pt', help='path to lstm weights file')

    parser.add_argument('--consumers', default=False, action='store_true', help='use Consumers dataset')
    return parser
...
def main(exp, args, num_gpu):
    ...
    *_, summary = evaluator.evaluate(
    ...
    if args.mot20:
        ...
        gtfiles = glob.glob(os.path.join('datasets/Consumers', '*/gt/gt.txt'))
    else:
        gtfiles = glob.glob(os.path.join('datasets/mot/mot/train', '*/gt/gt{}.txt'.format(gt_type)))
